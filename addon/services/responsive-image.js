...
const extentionTypeMapping = new Map([['jpg', 'jpeg']]);
...
export default class ResponsiveImageService extends Service {
  ...
  getType(imageName) {
    ...
    return extentionTypeMapping.get(extension) ?? extension;
  }
   ...
   * @public
   */
  getImageBySize(imageName, size, type) {
   ...
   * @public
   */
  getImageDataBySize(imageName, size, type = this.getType(imageName)) {
