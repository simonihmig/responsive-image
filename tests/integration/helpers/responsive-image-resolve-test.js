...
describe('Helper: ResponsiveImageResolve', function() {
  ...
  it('works without size', async function() {
    ...
    expect(find('*').textContent.trim()).to.equal("/assets/images/responsive/test100w-00e24234f1b58e32b935b1041432916f.png");
  });
  ...
  it('is size aware', async function() {
    ...
    expect(find('*').textContent.trim()).to.equal("/assets/images/responsive/test50w-00e24234f1b58e32b935b1041432916f.png");
  });
});
