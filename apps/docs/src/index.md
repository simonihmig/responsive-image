...
features:
  - title: Multi-Framework
    details: 'Supports Vite and Webpack for local image processing, a framework-agnostic core and components for multiple frameworks: Ember, React, Solid, Svelte, Vue and a universal web component.'
